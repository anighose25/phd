  ...
  public:
    ...
    class Node {
      ...
      public:
        ...
        inline Node *GetParentRaw() { return m_Parent; }
        ...
        inline void SetParent(Node *p) {
            m_Parent = reinterpret_cast<Node *>(
                (std::size_t)p | ((std::size_t)m_Parent & 2) | 1);
        }

        inline NodeColor GetColor() {
            if (m_Parent == nullptr)
                return NodeColor::BLACK;
            return (std::size_t)m_Parent & 2 ? NodeColor::RED
                                             : NodeColor::BLACK;
        }
        ...
        inline void SetColor(NodeColor color) {
            if (color == NodeColor::RED)
                ...
                m_Parent = reinterpret_cast<Node *>((std::size_t)m_Parent &
                                                    ~((std::size_t)2));
        }
    };
