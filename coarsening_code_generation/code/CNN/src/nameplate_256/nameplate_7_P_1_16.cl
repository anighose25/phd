__kernel void pooling_7( __global const float* b18, __global float* b19)
{
	...
	if(dp_10< 128*16*8)
	{
		...
		localId_P = dp_10 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_10 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
	...
	if(dp_11< 128*16*8)
	{
		...
		localId_P = dp_11 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_11 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
	...
	if(dp_12< 128*16*8)
	{
		...
		localId_P = dp_12 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_12 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
	...
	if(dp_13< 128*16*8)
	{
		...
		localId_P = dp_13 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_13 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
	...
	if(dp_14< 128*16*8)
	{
		...
		localId_P = dp_14 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_14 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
	...
	if(dp_15< 128*16*8)
	{
		...
		localId_P = dp_15 % (16*8);
		outputRow_P = localId_P / 16;
		outputCol_P = localId_P % 8;
		image2dIdx_P = dp_15 / (16*8);
		plane_P = image2dIdx_P % 128;
		n_P = image2dIdx_P / 128;
		if(n_P > 1) 
			return;
