__kernel void pooling_9( __global const float* b8, __global float* b9)
{
	...
	if(dp_0< 128*8*4)
	{
		...
		if(process)
		{
			...
			data1_P = vload2(0,(__global const float *)b8+poolInputOffset+16);
