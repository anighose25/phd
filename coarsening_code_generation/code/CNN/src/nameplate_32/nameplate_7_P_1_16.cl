__kernel void pooling_7( __global const float* b18, __global float* b19)
{
	...
	if(dp_0< 128*2*2)
	{
		...
		if(process)
		{
			...
			data1_P = vload2(0,(__global const float *)b18+poolInputOffset+4);
