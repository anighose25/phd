__kernel void pooling_11( __global const float* b18, __global float* b19)
{
	...
	if(dp_0< 4*0*0)
	{
		...
		if(process)
		{
			...
			data1_P = vload2(0,(__global const float *)b18+poolInputOffset+1);
