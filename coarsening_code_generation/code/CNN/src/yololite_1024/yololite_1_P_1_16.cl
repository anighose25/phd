__kernel void pooling_1( __global const float* b18, __global float* b19)
{
	...
	if(dp_0< 16*512*512)
	{
		...
		if(process)
		{
			...
			data1_P = vload2(0,(__global const float *)b18+poolInputOffset+1024);
	...
	if(dp_8< 16*512*512)
	{
		...
		localId_P = dp_8 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_8 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_9< 16*512*512)
	{
		...
		localId_P = dp_9 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_9 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_10< 16*512*512)
	{
		...
		localId_P = dp_10 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_10 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_11< 16*512*512)
	{
		...
		localId_P = dp_11 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_11 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_12< 16*512*512)
	{
		...
		localId_P = dp_12 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_12 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_13< 16*512*512)
	{
		...
		localId_P = dp_13 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_13 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_14< 16*512*512)
	{
		...
		localId_P = dp_14 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_14 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
	...
	if(dp_15< 16*512*512)
	{
		...
		localId_P = dp_15 % (512*512);
		outputRow_P = localId_P / 512;
		outputCol_P = localId_P % 512;
		image2dIdx_P = dp_15 / (512*512);
		plane_P = image2dIdx_P % 16;
		n_P = image2dIdx_P / 16;
		if(n_P > 1) 
			return;
